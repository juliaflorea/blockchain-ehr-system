...
function displaySentAppointmentRequest(id, appointment, status, doctorName) {
  ...
  if (status === "Accepted") statusCell.html('<span class="status-badge accepted-status">Accepted</span>');
  else if (status === "Rejected") statusCell.html('<span class="status-badge rejected-status">Rejected</span>');
  else if (status === "Pending") statusCell.html('<span class="status-badge pending-status">Pending</span>');
  else statusCell.html('<span class="status-badge unknown-status">Unknown</span>');
