...
function downloadMedicalRecord(data) {
  // Function to remove HTML tags and unwanted titles for cleaner text in PDF
  function cleanData(data) {
    ...
    // Remove any existing "Medical Record" mentions from the data
  ...
  doc.text("Medical Record", 105, 20, { align: "center" }); // Adjust 'y' position as needed

  doc.setFontSize(12);
  doc.setFont("helvetica", "normal");
  doc.text(cleanedData, 10, 30, { maxWidth: 180 }); // Adjust 'y' position to start below the title
