  ...
  if (window.ethereum) {
    ...
    window.ethereum
      ...
      .then((accounts) => {
        ...
        const ContractAddress = "0x68EB5F20Cd1cd383774345cE2cC4404f6d40e1B8";
       const abi = [
        {
          "constant": true,
          "inputs": [
        ...
        },
        {
          ...
          "outputs": [
            ...
            {
              "name": "diagnosisSubmitted",
              "type": "bool"
            },
            {
              "name": "treatmentPlanSubmitted",
              "type": "bool"
            }
          ],
          "payable": false,
        ...
        },
        {
          ...
          "inputs": [
            ...
            {
              "name": "treatmentPlanIPFSHash",
              "type": "string"
            }
          ],
          "name": "submit_TreatmentPlan",
          "outputs": [],
          "payable": false,
          "stateMutability": "nonpayable",
          "type": "function"
        ...
        },
        {
          ...
          "name": "get_accessed_patientlist_for_proxy",
          "outputs": [
            {
              "name": "",
              "type": "address[]"
        ...
        },
        {
          ...
          "name": "get_accessed_proxylist_for_patient",
          "outputs": [
            {
              "name": "",
              "type": "address[]"
        ...
        },
        {
          ...
          "name": "requestAppointmentByProxy",
          "outputs": [],
          "payable": false,
          "stateMutability": "nonpayable",
          "type": "function"
